...
| **厕拍** | 标题含「厕拍」 |
| **黑人** | 标题含「黑人」 |
| **情色分享** | 标题含「情色分享」（**例外**：标题同时含 ed2k/115Ed2k/115eD2k 等标记时保留为 `ed2k` 子类） |
...
**Content filter (default):** Japanese **有码** + **无码破解** + **国产/ed2k**（泄密/流出/熟女自拍/酒店偷拍/ed2k；排除私拍/厕拍/黑人/情色分享/AI增强/AI短剧/AI真人短剧/伪番号/OnlyFans；**115ed2k 标题不因情色分享排除**）。详见 **§6 国产无码规则**。Western、FC2、素人 JAV 排除。`--all-regions` 关闭全部过滤。
